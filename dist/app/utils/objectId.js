...
exports.normalizeIdOrThrow = normalizeIdOrThrow;
// src/utils/objectId.ts
const mongoose_1 = require("mongoose");
const apiError_1 = __importDefault(require("../utils/apiError"));
function diag(label, v) {
...
function toObjectId(value, field) {
    ...
    if (typeof value === "string")
        ...
        throw new apiError_1.default(`${field} must be an ObjectId`, 400);
    try {
    ...
    if (m)
        return new mongoose_1.Types.ObjectId(m[0]);
    diag(field, s);
    throw new apiError_1.default(`${field} must be a valid 24-char ObjectId string`, 400);
}
/** Normalize any id (string/ObjectId) to a validated 24-hex string. */
function normalizeIdOrThrow(id, label = "id") {
    ...
    if (m)
        return m[0];
    diag(label, s);
    throw new apiError_1.default(`Invalid ${label}`, 400);
}
